...
pluralCaseList.push( {plural: "works/workOrders", pascal: "WorkWorkOrder"} )

pluralCaseList.push( {plural: "accountInfos/accountInfos", pascal: "AccountInfoAccountInfo"} )

pluralCaseList.push( {plural: "workTypes/workTypes", pascal: "WorkTypeWorkType"} )


pluralCaseList.push( {plural: "userInfos/userInfos", pascal: "UserInfoUserInfo"} )
