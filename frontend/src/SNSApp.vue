    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'accountInfos', 
                route: '/accountInfos/accountInfos',
                ImageUrl: '',
            },
            { 
                title: 'WorkType', 
